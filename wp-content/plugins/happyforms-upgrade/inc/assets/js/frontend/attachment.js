( function( $, settings, window ) {
	...
	HappyForms.parts.attachment = {
		...
		initUploader: function() {
			...
			this.uploader.bind( 'FilesRemoved', this.onFilesRemoved.bind( this ) );
		...
		refreshList: function() {
			...
			if ( this.maxFileCount > 0 ) {
				this.$fileCounter.text( this.uploader.files.length );
			}
...
} )( jQuery, _happyFormsAttachmentSettings, window );
